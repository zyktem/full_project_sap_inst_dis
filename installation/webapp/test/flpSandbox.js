					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Installation and Dismental",
									"targetURL": "#installation-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"installation-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=installation",
									"url": sap.ui.require.toUrl("installation")
								}
							}
						}
					}
