					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Polluton Tracker",
									"targetURL": "#pollution-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"pollution-display": {
								"semanticObject": "pollution",
								"action": "display",
								"description": "SAP Pollution Tracker",
								"title": "Polluton Tracker",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=pollution",
									"url": sap.ui.require.toUrl("pollution")
								}
							}
						}
					}
