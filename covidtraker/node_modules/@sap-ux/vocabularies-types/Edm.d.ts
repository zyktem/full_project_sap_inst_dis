...
export type ConditionalCheck = OrConditionalExpression | AndConditionalExpression | NotConditionalExpression | EqConditionalExpression | NeConditionalExpression | GtConditionalExpression | GeConditionalExpression | LtConditionalExpression | LeConditionalExpression;
...
export type RemoveAnnotationAndType<T> = {
    [K in keyof Omit<T, 'annotations' | 'targetType' | 'isKey' | 'resolvePath' | 'entityType' | 'navigationProperties' | 'entitySets' | 'singletons' | 'actionImports'>]: T[K] extends object ? T[K] extends Array<infer Item> ? RemoveAnnotationAndType<Item>[] : RemoveAnnotationAndType<T[K]> : T[K];
};
