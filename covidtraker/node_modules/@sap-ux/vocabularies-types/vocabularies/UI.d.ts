...
export type HeaderInfoType = ComplexType & {
    ...
    */
    Image?: PropertyAnnotationValue<Edm.Stream>;
    /**
...
export type ReferenceFacet = ComplexType & Omit<Facet, '$Type'> & {
    ...
    */
    Target: Edm.AnnotationPath<Communication.Address | Communication.Contact | Badge | Chart | Contacts | DataPoint | FieldGroup | GeoLocation | GeoLocations | HeaderInfo | Identification | KPI | LineItem | MediaResource | PresentationVariant | SelectionFields | SelectionPresentationVariant | StatusInfo>;
};
/**
...
export type DataFieldForAnnotation = ComplexType & Omit<DataFieldAbstract, '$Type'> & {
    ...
    */
    Target: Edm.AnnotationPath<Communication.Address | Communication.Contact | Chart | ConnectedFields | DataPoint | FieldGroup>;
};
/**
  Triggers an action
*/
...
export type DataField = ComplexType & Omit<DataFieldAbstract, '$Type'> & {
    ...
    */
    Value: PropertyAnnotationValue<Edm.Untyped>;
};
/**
...
} & AnnotationTerm<PropertyAnnotationValue<RecommendationStateType>>;
/**
  Indicates whether a field contains or has a recommended value
*/
