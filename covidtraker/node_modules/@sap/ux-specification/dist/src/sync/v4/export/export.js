...
function exportManifestChange(ids, syncRule, transferParameters, configPropertyKey, configObject, propertyDefinition, nextDefinition) {
    ...
    (0, utils_1.deleteEmptyStructure)(transferParameters.exportResults.manifest, path, targetAnnotation, targetAnnotationEncoded);
}
/**
...
const exportObjectPage = (exportParameters, ui5Version) => {
    ...
    const pageLayoutInformation = (0, common_1.getPageLayoutInformation)(objectPage);
        ...
        if (syncRule && syncRule.manifest) {
            ...
            if (syncRule.manifest.export) {
                ...
                if (application.settings?.[key] !== undefined) {
                    ...
                    (0, utils_1.deleteEmptyStructure)(exportResults.manifest, path);
                }
            }
        }
    }
...
const exportPageV4 = (exportParametersV4, ui5Version) => {
    if (exportParametersV4[ux_specification_types_1.SchemaType.ListReport]) {
        ...
        return (0, fpmCustomPage_1.exportFPMCustomPageConfig)(exportParametersV4[ux_specification_types_1.SchemaType.FPMCustomPage], exports.defaultExportResult);
    }
};
