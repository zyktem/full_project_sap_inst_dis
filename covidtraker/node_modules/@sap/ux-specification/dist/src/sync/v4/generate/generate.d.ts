 ...
 */
export declare function generateObjectPageInterfaceV4(genericSchema: object, entitySetName: string, annotations: FileData[], manifest: object, logger?: ExtensionLogger, fragments?: FileData[], contextPath?: string): object;
/**
 ...
 * @returns the app specific JSON schema
 */
export declare function generateListReportInterfaceV4(templateType: TemplateType, genericSchema: object, entitySetName: string, annotations: FileData[], logger?: ExtensionLogger, manifest?: object, contextPath?: string): object;
/**
