...
function analyzeViewAnnotation(annotationPath, uIAnnotations, generateParameters, viewKey, visualizationType) {
    ...
    const alias = (0, common_1.findAlias)(ux_specification_types_1.UIVOCABULARY, generateParameters.serviceAVT);
...
function generateListReportSchemaV4(generateParameters, genericSchema, templateName, contextPath) {
    ...
    if (generateParameters.manifest) {
        ...
        const v4Page = (0, utils_1.findPageV4)(pages, templateName, generateParameters.entitySet, contextPath, generateParameters.logger);
        if (!v4Page) {
            return appSchema;
        }
