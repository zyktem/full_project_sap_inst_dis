...
function generateObjectPageInterfaceV4(genericSchema, entitySetName, annotations, manifest, logger, fragments, contextPath) {
    ...
    const { entitySet, entityType } = (0, importProject_1.getEntityTypeEntitySetFromContextPath)(serviceAVT, contextPath, entitySetName);
    ...
    return (0, _1.generateObjectPageSchemaV4)(generateParameters, genericSchema, contextPath);
}
...
function generateFPMCustomPageInterfaceV4(genericSchema, routingId, manifest, views, annotations, featureToggles, logger) {
    ...
    if ((0, utils_1.isFeatureSupported)(featureToggles, ux_specification_types_1.Features.BuildingBlocks)) {
        const serviceAVT = (0, utils_1.parseAndMergeAndConvert)(annotations, logger);
        const viewData = (0, utils_2.getPageCustomViewFile)(views || [], routingId, manifest);
        schema = viewData?.file.fileContent
            ? (0, _1.generateCustomPageSchemaV4)(genericSchema, viewData, serviceAVT, logger)
            : {};
    }
    return schema;
}
