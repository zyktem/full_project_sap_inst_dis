...
function transferColumns(config, importParameters, factory, pageType, routingId, configId, viewId) {
    ...
    if (lineItems) {
        ...
        for (const columnKey in lineItems.properties) {
            ...
            (0, utils_1.transferSettingsOfObject)(config.columns[columnKey], importParameters.manifest, schemaDefinitions[schemaPropertyName], routingId, [columnKey, targetAnnotation], targetAnnotation, importParameters.logger);
    ...
    if (typeof visualFilters === 'object') {
        for (const visualFilter in visualFilters.properties) {
            ...
            if (typeof filterDefinition === 'object' && filterDefinition.$ref) {
                ...
                (0, utils_1.transferSettingsOfObject)(filterBarConfig.visualFilters[visualFilter], importParameters.manifest, schemaDefinitions[definitionKey], routingId, [visualFilter]);
            }
        }
    ...
    if (typeof actionsDefinition === 'object') {
        for (const actionKey in actionsDefinition.properties) {
            ...
            if (typeof actionDefinition === 'object' && actionDefinition.$ref) {
                ...
                (0, utils_1.transferSettingsOfObject)(tableConfig.toolBar.actions[actionKey], importParameters.manifest, schemaDefinitions[definitionKey], routingId, [actionKey, targetAnnotation]);
...
function transferToolBar(importParameters, config, factory, pageType, routingId, columnDefinitionName = ux_specification_types_1.DefinitionName.LineItems, viewId) {
    ...
    (0, utils_1.transferSettingsOfObject)(table.toolBar, importParameters.manifest, importParameters.jsonSchema.definitions[ux_specification_types_1.DefinitionName.ToolBarLR], routingId, []);
...
function importALPViews(importParameters, config, factory, pageType, routingId) {
    ...
    (0, utils_1.transferSettingsOfObject)(config.chart, importParameters.manifest, chartDefinition, routingId, [
    ...
    (0, utils_1.transferSettingsOfObject)(config.chart.toolBar, importParameters.manifest, schemaDefinitions[ux_specification_types_1.DefinitionName.ViewChartToolBar], routingId, []);
    //table view
    ...
    if (tableAnnotationPath) {
        ...
        (0, utils_1.transferSettingsOfObject)(tableConfig, importParameters.manifest, tableDefinition, routingId, [
...
function importLRViews(importParameters, config, factory, pageType, routingId) {
    ...
    (0, utils_1.transferSettingsOfObject)(tableViewConfig, importParameters.manifest, schemaDefinitions[ux_specification_types_1.DefinitionName.MultiTableModeV4], routingId, []);
    ...
    for (const element of sortedList) {
        ...
        if (element[1]['$ref']) {
            ...
            (0, utils_1.transferSettingsOfObject)(tableView, importParameters.manifest, schemaDefinitions[nextDefinition], routingId, [element[0], targetAnnotation]);
    ...
    if (typeof actions === 'object') {
        ...
        for (const actionKey in actions.properties) {
            ...
            if (typeof definition === 'object' && definition.$ref) {
                ...
                (0, utils_1.transferSettingsOfObject)(listReportPageConfig[actionType].actions[actionKey], manifest, appSchema.definitions[key], routingId, [actionKey.replace('/', '??')]);
...
function addSettings(importParameters, config, factory, pageType, routingId, schemaType) {
    ...
    (0, utils_1.transferSettingsOfObject)(config, importParameters.manifest, importParameters.jsonSchema, routingId, []);
    config.header = factory.createInstance(pageType, ux_specification_types_1.DefinitionName.Header);
    (0, utils_1.transferSettingsOfObject)(config.header, importParameters.manifest, importParameters.jsonSchema.definitions[ux_specification_types_1.DefinitionName.Header], routingId, []);
    ...
    (0, utils_1.transferSettingsOfObject)(config.filterBar, importParameters.manifest, importParameters.jsonSchema.definitions[ux_specification_types_1.DefinitionName.FilterBar], routingId, []);
    ...
    if (schemaType === ux_specification_types_1.SchemaType.ListReport) {
        ...
        (0, utils_1.transferSettingsOfObject)(config.table, importParameters.manifest, tableDefinition, routingId, [
            definitionName,
            targetAnnotation
        ]);
        //transfer toolbar
