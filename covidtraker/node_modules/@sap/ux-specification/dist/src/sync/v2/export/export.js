...
function processProperties(configObject, exportResults, appSchema, propertyList, factory, pathHierarchy) {
    ...
    for (const key in propertyList) {
        ...
        let syncRule = (0, common_1.getReflectMetadata)(configObject, key);
        ...
        if (isAnyOfObject) {
            ...
            syncRule = (0, common_1.getReflectMetadata)(configObject, pathHierarchy[pathHierarchy.length - 1]);
        }
...
function evaluateManifestRule(transferParameters, path, syncRule, key, configObject) {
    ...
    if (configObject[key] !== undefined) {
        ...
        (0, common_1.deleteEmptyStructure)(transferParameters.exportResults.manifest, path);
    }
}
