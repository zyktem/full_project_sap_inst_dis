 ...
 */
export declare function generateObjectPageInterfaceV2(genericSchema: object, entitySet: string, annotations: FileData[], manifest: object, fragments?: FileData[], logger?: ExtensionLogger): object;
/**
 ...
 * @returns the app specific JSON schema
 */
export declare function generateListReportInterfaceV2(genericSchema: object, entitySet: string, annotations: FileData[], manifest: object, fragments?: FileData[], logger?: ExtensionLogger): object;
/**
 ...
 * @returns the app specific JSON schema
 */
export declare function generateAnalyticalListPageInterfaceV2(genericSchema: object, entitySet: string, annotations: FileData[], manifest: object, fragments?: FileData[], logger?: ExtensionLogger): object;
/**
 ...
 */
export declare function generateOVPInterfaceV2(genericSchema: object, manifest: object): object;
