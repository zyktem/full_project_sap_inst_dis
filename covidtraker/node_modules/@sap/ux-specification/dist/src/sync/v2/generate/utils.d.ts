 ...
 */
export declare function addTabkeyEnum(appSchema: object, definitionName: string, page?: v2.SapUiAppPageV2): void;
/**
 ...
 */
export declare function addTableColumnExtensions(appSchema: object, entityType: EntityType, page: v2.SapUiAppPageV2, manifest: object, fragments?: FileData[], customColumnsDefinitionName?: string, customColumnDefinitionName?: string): void;
/**
...
export declare function processMetadata(schema: object, schemaDefinition: object, metaDataDefinition: {
    [key: string]: any;
}, pageType: PageTypeV2 | PageTypeV4, factory: MetadataInstanceInterface): void;
/**
