					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Installation and Dismentle",
									"targetURL": "#dismentle-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"dismentle-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=dismentle",
									"url": sap.ui.require.toUrl("dismentle")
								}
							}
						}
					}
