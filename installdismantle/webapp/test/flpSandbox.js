		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Install and Dismantle",
									"targetURL": "#installdismantle-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"installdismantle-display": {
								"semanticObject": "installdismantle",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=installdismantle",
									"url": sap.ui.require.toUrl("installdismantle")
								}
							}
						}
					}
