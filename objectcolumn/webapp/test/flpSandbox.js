		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Object Column Layout",
									"targetURL": "#objectcolumn-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"objectcolumn-display": {
								"semanticObject": "objectcolumn",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=objectcolumn",
									"url": sap.ui.require.toUrl("objectcolumn")
								}
							}
						}
					}
